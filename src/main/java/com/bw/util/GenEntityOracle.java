...
public class GenEntityOracle {
    ...
    private String authorName = "wangbo";// ��������
    private String tablename = "eb_brand";// ����
    private String packageOutPath = "main.java.com.bw.bean";// ָ��ʵ���������ڰ���·��
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/1705h?user=root&password=123456&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        //�������Ǳ���  ���ɵ�ʵ������ĸ��д   ������User
    	//��һ����������    �ڶ�������ʵ������    �������������ݿ�����
        new GenEntityOracle("mtv","Mtv","1705h").init();  
